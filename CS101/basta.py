...
# Calculate bill for brunch menu items.
# print(brunch_menu.calculate_bill(['pancakes', 'waffles', 'home fries']))
...
# Calculate bill for early bird menu items.
...
# Calculate bill for dinner menu items.
...
# Calculate bill for kids menu items.
