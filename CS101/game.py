...
def health_inspector_kenny(visited):
    if visited == 0:
        print(textwrap.fill(lb + "Welcome Health Inspector Kenny.\nToday you have to inspect three restaraunts and give them ratings.",
        ...
        if locations[choice] == "Billy's Big Burgers":
            ...
            print(textwrap.fill("You've finished inspecting \"Billy's Big Burgers\" and have given it a grade of {0}.".format(
            ...
            print(textwrap.fill("You've finished inspecting \"Lucy's Lemonade and Licorice\" and have given it a grade of {0}.".format(
            ...
            print(textwrap.fill("You've finished inspecting \"Laura's Luncheonette\" and have given it a grade of {0}.".format(
...
def billys_burgers():
    ...
    for i in range(len(areas)):
        ...
        if areas[choice] == "Dining Room":
            ...
            if response == 2:
                billys_grade -= 1
            print(textwrap.fill(lb + "You mark your grade for the {0} on your clipboard. The grade for Billy's Big Burgers is currently {1}".format(
...
def lauras_luncheonette():
    ...
    for i in range(len(areas)):
        ...
        if areas[choice] == "Dining Room":
            ...
            if response == 2:
                lauras_grade -= 1
            print(textwrap.fill(lb + "You mark your grade for the {0} on your clipboard. The grade for Laura's Luncheonette is currently {1}".format(
...
def lucys_lemonade():
    ...
    for i in range(len(areas)):
        ...
        if areas[choice] == "Dining Room":
            ...
            if response == 2:
                lucys_grade -= 1
            print(textwrap.fill(lb + "You mark your grade for the {0} on your clipboard. The grade for Lucy's Lemonade and Licorice is currently {1}".format(
...
lb = "------------------------------------------------------------\n"
grades = ["F", "C", "B", "A"]
locations = ["Billy's Big Burgers",
             "Lucy's Lemonade and Licorice", "Laura's Luncheonette"]
...
dirty_responses = ["Oh god, it's so gross", "I can't breathe in here", "Quite dirty",
                   "Very dirty", "Really disgusting", "Dirtier than a dumpster", "I wouldn't eat here"]
visited = 0
